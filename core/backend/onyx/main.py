...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    # mynd Core: attach the Mynd Labs layer (product routing, per-product audit,
    # user/org LLM credentials). Single call keeps the upstream Onyx diff minimal
    # and rebase-friendly. See core/backend/mynd/integration.py.
